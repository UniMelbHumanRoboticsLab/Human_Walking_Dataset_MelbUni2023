...
message = ['Select folder where data are saved (i.e., segEnergetics)']; 
disp(message);
...
subjects = [1 2 3 4 5 6 8 9 10 11 13 14 15 16 17 18 19 20 21];
...
for sub = 1 : 2%: 21
   ...
   title(strcat('Resting MC Sess3 Sub',num2str(sub)))   
   % - - - - - - - 
   subplot(3,2,[3 4])
   ...
   ylabel('cost [W/kg]'), title(strcat('Tests MC Sub',num2str(sub)))
   % - - - - - - - 
   subplot(3,2,[5 6])
   ...
   ylabel('cost [J/kgm]'), title(strcat('Tests CoT Sub',num2str(sub)))
